...
class TerminalDisplayV2:
    ...
    def getCoordinates(self, height, width):
        ...
        row = self.inputInt("Select a row for your next move", 1, height)
        column = self.inputInt("Select a column for your next move", 1,  width)

        return((int(column), int(row)))

    def inputList(self, text, options):
    ...
    def displayGame(self, dictionary):
    ...
    def displayDebug(self, dictionary):
